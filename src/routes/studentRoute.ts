...
//SKILLS ROUTES
// studentRouter.put("/profile/skills",middleware,cont_func);
// studentRouter.post("/profile/skills",middleware,cont_func);
// studentRouter.delete("profile/skills",middleware,cont_func);
...
studentRouter.delete("profile/achievement/:achievementID",middleware,cont_func);
...
studentRouter.delete("profile/certificate/:certificate:ID",middleware,cont_func);
